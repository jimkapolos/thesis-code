...
from keras.layers import LSTM, Dense, Bidirectional, MaxPooling1D,GRU
...
def main() -> None:
    ...
    model = Sequential()
    model.add(Conv1D(filters=64, kernel_size=3, activation='tanh', input_shape=(n_steps_in, n_features),
